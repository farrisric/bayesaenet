...
model_kwargs = {'net': net,
        ...
        'prior_loc': 0, 
        'guide': 'normal', 
        'lr': 0.0008890786336449584, 
        'mc_samples_train': 2, 
        'obs_scale': 0.32307694226721123, 
        'pretrain_epochs': 0, 
        'prior_scale': 0.03768930347825263, 
        'q_scale': 0.00018031343066096295
        }
...
trainer.predict(model=model, datamodule=datamodele, ckpt_path=ckpt_path)
...
for name, dataset in zip(names, datasets):
    ...
    ax[1].legend()
    fig.savefig(f'predict/correlation_{name}.png')
    ...
    fig.savefig(f'predict/uncertanty_analysis_{name}.png')
