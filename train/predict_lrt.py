...
ckpt_path = glob.glob('/home/g15farris/bin/bayesaenet/src/logs/train_lrt/runs/2024-05-07_10-09-06/checkpoints/e*.ckpt')[0]
...
for name, dataset in zip(names, datasets):
    ...
    ax[1].legend()
    fig.tight_layout()
    fig.savefig(f'predict/lrt_correlation_{name}.png')
    ...
    fig.savefig(f'predict/lrt_uncertanty_analysis_{name}.png')
