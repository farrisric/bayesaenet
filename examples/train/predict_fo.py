...
ckpt_path = glob.glob('/home/g15farris/bin/bayesaenet/src/logs/train_fo/runs/2024-05-07_13-14-09/checkpoints/e*.ckpt')[0]
...
for name, dataset in zip(names, datasets):
    ...
    ax[1].legend()
    fig.tight_layout()
    fig.savefig(f'predict/fo_correlation_{name}.png')
    ...
    fig.savefig(f'predict/fo_uncertanty_analysis_{name}.png')
