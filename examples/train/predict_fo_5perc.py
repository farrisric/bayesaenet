...
datamodele = AenetDataModule(data_dir='../data/PdO/train.in',batch_size=100,test_split=0.8,valid_split=0.1)
...
model_kwargs = {'net': net,
        ...
        'guide': 'normal',
        'prior_loc': 0,
        'prior_scale': 0.09932446036472457,
        'q_scale': 0.00019597689702210863,
        'obs_scale': 0.4404073995649562,
        }
...
ckpt_path = glob.glob('/home/g15farris/bin/bayesaenet/src/logs/train_fo/runs/2024-05-10_11-12-13/tensorboard/version_0/checkpoints/epoch=9999-step=480000.ckpt')[0]
...
for name, dataset in zip(names, datasets):
    ...
    fig.savefig(f'predict/fo_uncertanty_analysis_{name}_5perc.png')
