...
#SBATCH --output=/home/g15farris/bin/bayesaenet/log/predict/TiO2_big_pred_nn.out
#SBATCH --errror=/home/g15farris/bin/bayesaenet/log/predict/TiO2_big_pred_nn.err
...
mkdir -p log/predict
mkdir -p bnn_aenet/logs/TiO2_big/pred/runs/nn

python -m bnn_aenet.tasks.predict_forces \
    --model-type nn \
    --runs-dir bnn_aenet/logs/TiO2_big/train/runs/nn \
    --output-dir bnn_aenet/logs/TiO2_big/pred/runs/nn \
