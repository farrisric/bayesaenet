...
task_name=predict_lrt_{}perc \
prediction=PdO \
ckpt_path=all \
+method=LRT \
runs_dir=bnn_aenet/logs/train_lrt_{} 
""".format(perc, python_path, perc, perc)
    
    with open(f"/home/g15farris/bin/bayesaenet/results/PdO/bnn_lrt/predict/predict_lrt_{perc}.sh", "w") as f:
        f.write(job_file)
