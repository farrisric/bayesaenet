...
work_dir = '/home/g15farris/bin/bayesaenet/bnn_aenet/logs/predict/runs/*/'

parquets = [x for x in glob.glob('/home/g15farris/bin/bayesaenet/bnn_aenet/logs/predict/runs/*/*parquet')] 
...
for i, parquet in enumerate(parquets):
    ...
    perc = int(100/15336*len(y_true))
    name = f"{parquet.split('/')[-1].split('.')[0]}_{perc}%"
