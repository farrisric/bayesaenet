...
python bnn_aenet/tasks/predict.py task_name=predict_commitie_5perc prediction=PdO ckpt_path=all +method=NN runs_dir=bnn_aenet/logs/train_nn_commitie_5perc
