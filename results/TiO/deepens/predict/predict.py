...
for i, train_percentage in enumerate(
    sorted(glob.glob('/home/g15farris/bin/bayesaenet/bnn_aenet/logs/TiO_pred_deepens_*perc/')
    )):
    ...
    fig.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/deepens/predict/combined_corr_{train_percentage}.png', dpi=300)
    plt.close(fig)
    ...
    fig.subplots_adjust(top=0.85)
    fig.suptitle('Commitee Prediction Analysis', fontsize=20)
    fig.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/deepens/predict/deepens_{train_percentage}.png', dpi=300)
    plt.close(fig)