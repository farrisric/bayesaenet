...
python bnn_aenet/tasks/predict.py task_name=TiO_pred_deepens_5perc prediction=TiO ckpt_path=all +method=NN runs_dir=bnn_aenet/logs/TiO_train_deepens_5perc
