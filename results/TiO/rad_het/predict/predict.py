...
parquets = sorted(glob.glob('/home/g15farris/bin/bayesaenet/bnn_aenet/logs/predict_rad_*perc/**/*parquet', recursive=True))
...
for i, parquet in enumerate(parquets):
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/rad_het/predict/{name_file}_{train_percentage}.png', dpi=300)
    plt.close(fig)
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/rad_het/predict/{name_file}_{train_percentage}_uct.png', dpi=300)
