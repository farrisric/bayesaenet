...
parquets = sorted(glob.glob('/home/g15farris/bin/bayesaenet/bnn_aenet/logs/*_mcd_*perc/**/*parquet', recursive=True))
...
for i, parquet in enumerate(parquets):
    ...
    name = f"MDC - Train Perc: {train_percentage}%"
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/mcd/predict/{name_file}_{train_percentage}.png', dpi=300)
    plt.close(fig)
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/mcd/predict/{name_file}_{train_percentage}_uct.png', dpi=300)
