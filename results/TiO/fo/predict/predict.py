...
parquets = sorted(glob.glob('/home/g15farris/bin/bayesaenet/bnn_aenet/logs/predict_fo_*perc/**/*parquet', recursive=True))
...
for i, parquet in enumerate(parquets):
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/fo/predict/fo_{train_percentage}.png', dpi=300)
    plt.close(fig)
