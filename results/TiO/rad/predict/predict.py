...
for i, parquet in enumerate(parquets):
    ...
    test_percentage = int(parquet.split('/')[-4].split('_')[-1].replace('perc', ''))
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/rad/predict/rad_{train_percentage}.png', dpi=300)
    plt.close(fig)