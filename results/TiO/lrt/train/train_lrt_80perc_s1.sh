...
python bnn_aenet/tasks/train.py \
    ...
    task_name=final_TiO_train_lrt_80_sigmaprior1 \
    datamodule=TiO \
    datamodule.test_split=0.1 \
    datamodule.valid_split=0.1 \
    datamodule.batch_size=32 \
    model.lr=0.0006095127866361645 \
    model.pretrain_epochs=5 \
    model.mc_samples_train=1 \
    model.mc_samples_eval=20 \
    model.prior_loc=0 \
    model.prior_scale=1.00 \
    model.q_scale=0.0006986123667546038 \
    model.obs_scale=0.23320974576752274
