...
parquets = sorted(glob.glob('/home/g15farris/bin/bayesaenet/bnn_aenet/logs/TiO_pred_hnn_80perc/**/*parquet', recursive=True))
...
for i, parquet in enumerate(parquets):
    ...
    name = f"HNN - Train Perc: {train_percentage}%"
    ...
    fig.suptitle('HNN Analysis', fontsize=20)
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/hnn/predict/{name_file}_{train_percentage}.png', dpi=300)
    plt.close(fig)
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/hnn/predict/{name_file}_{train_percentage}_uct.png', dpi=300)