...
for i, parquet in enumerate(parquets):
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/lrt_het/predict/{name_file}_{train_percentage}.png', dpi=300)
    plt.close(fig)
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/lrt_het/predict/{name_file}_{train_percentage}_uct.png', dpi=300)
