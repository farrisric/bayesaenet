...
def split_database(dataset_size, valid_split, test_split, seed=42):
	...
	#train_indices = np.genfromtxt('/home/g15telari/TiO/Indices_Training/HomoValid_RandTest/train_set_idxes.txt').astype(int)
	#valid_indices = np.genfromtxt('/home/g15telari/TiO/Indices_Training/HomoValid_RandTest/valid_set_idxes.txt').astype(int)
	#test_indices = np.genfromtxt('/home/g15telari/TiO/Indices_Training/HomoValid_RandTest/test_set_idxes.txt').astype(int)
	np.savetxt('/home/g15telari/TiO/bayesaenet/Idxes/train_idxes.dat',np.array(list(train_indices)))
	np.savetxt('/home/g15telari/TiO/bayesaenet/Idxes/valid_idxes.dat',np.array(list(valid_indices)))
	np.savetxt('/home/g15telari/TiO/bayesaenet/Idxes/test_idxes.dat',np.array(list(test_indices)))
