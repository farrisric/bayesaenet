"""
BNN with custom joint energy+force likelihood (ELBO-integrated).

Unlike BNN_Forces_Aux which uses auxiliary force loss, this model includes
forces directly in the variational objective via a custom Pyro model.
"""
...
class BNN_Forces_Likelihood(BNN):
    """
    ...
    def __init__(
        ...
        name: str = "BNN_Forces_Likelihood",
    ):
        super().__init__(
