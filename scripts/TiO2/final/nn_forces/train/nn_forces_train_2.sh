...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/logs/nn_forces/nn_forces_train_2.out
#$ -e /home/g15farris/bin/bayesaenet/logs/nn_forces/nn_forces_train_2.err
