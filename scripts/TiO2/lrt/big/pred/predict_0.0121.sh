...
python bnn_aenet/tasks/predict.py \
    task_name=lrt_pred \
    run_name=pred_0.0121\
    prediction=TiO \
    ckpt_path=/home/g15farris/bin/bayesaenet/bnn_aenet/logs/lrt_train_0.012/runs/2025-05-20_16-41-26/checkpoints/epoch_18815-step_1862784.ckpt\
