...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/multirun/TiO2_big_rad.out
#$ -e /home/g15farris/bin/bayesaenet/log/multirun/TiO2_big_rad.err
...
# Best params from latest hps_rad_bg run window (job 3525101), study rad_big, trial 29
LR=4.225383576476146e-05
BS=256
MC=1
PRIOR_SCALE=0.34787948768217236
Q_SCALE=6.043450382535991e-05
OBS_SCALE=0.1797327539828412
SCALE_FORCE=0.1395089580166126
