...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/multirun/TiO2_big_lrt.out
#$ -e /home/g15farris/bin/bayesaenet/log/multirun/TiO2_big_lrt.err
...
# Best params from latest hps_lrt_bg run window (job 3525102), study lrt_big, trial 25
LR=2.7459823354517773e-05
BS=128
MC=1
PRIOR_SCALE=0.3916543510871084
Q_SCALE=2.034356601981801e-05
OBS_SCALE=0.19115092548243554
SCALE_FORCE=0.3855844490037336
