...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/logs/predict/TiO2_small_pred_fo.out
#$ -e /home/g15farris/bin/bayesaenet/logs/predict/TiO2_small_pred_fo.err
...
python -m bnn_aenet.tasks.predict_forces \
    --model-type fo \
    --runs-dir bnn_aenet/logs/TiO2_small/fo_train \
    --output-dir bnn_aenet/logs/TiO2_small/forces_pred/fo \
    --data-dir data/TiO/train_forces.in \
    --subsets train val test \
    --device gpu \
    --batch-size 32 \
...
echo "  FO prediction submitted (iqtc13)"
