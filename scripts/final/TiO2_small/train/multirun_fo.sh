...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/logs/multirun/TiO2_small_fo.out
#$ -e /home/g15farris/bin/bayesaenet/logs/multirun/TiO2_small_fo.err
...
for i in $(seq 0 9); do
    echo "=== Starting FO run $i with seed ${SEEDS[$i]} at $(date) ==="
    python -m bnn_aenet.tasks.train \
        ...
        seed=${SEEDS[$i]}
    echo "=== Finished FO run $i at $(date) ==="
done
