...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/multirun/TiO2_small_rad_learn_noise.out
#$ -e /home/g15farris/bin/bayesaenet/log/multirun/TiO2_small_rad_learn_noise.err
...
# Best RAD HPS parameters (same as original + learn_noise=true)
...
for i in $(seq 0 9); do
    echo "=== Starting RAD learn_noise run $i with seed ${SEEDS[$i]} at $(date) ==="
    python -m bnn_aenet.tasks.train \
        ...
        seed=${SEEDS[$i]} \
        'tags=["TiO2_small", "rad", "learn_noise", "train"]'
    echo "=== Finished RAD learn_noise run $i at $(date) ==="
done
