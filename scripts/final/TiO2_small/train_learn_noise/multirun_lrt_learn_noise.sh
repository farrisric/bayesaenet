...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/multirun/TiO2_small_lrt_learn_noise.out
#$ -e /home/g15farris/bin/bayesaenet/log/multirun/TiO2_small_lrt_learn_noise.err
...
# Best LRT HPS parameters (same as original + learn_noise=true)
...
for i in $(seq 0 9); do
    echo "=== Starting LRT learn_noise run $i with seed ${SEEDS[$i]} at $(date) ==="
    python -m bnn_aenet.tasks.train \
        ...
        seed=${SEEDS[$i]} \
        'tags=["TiO2_small", "lrt", "learn_noise", "train"]'
    echo "=== Finished LRT learn_noise run $i at $(date) ==="
done
