...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/logs/multirun/rad_forces.out
#$ -e /home/g15farris/bin/bayesaenet/logs/multirun/rad_forces.err
...
# Best RAD Forces HPS parameters (trial 7, total_rmse/val = 78.87)
LR=0.00029994809793642315
BS=256
MC=1
PRIOR_SCALE=0.11881695873297937
Q_SCALE=4.1557941999062144e-05
OBS_SCALE=1.482114354612266

SEEDS=(121958 671155 131932 365838 259178 644167 110268 732180 54886 137337)

for i in $(seq 0 9); do
    echo "=== Starting RAD Forces run $i with seed ${SEEDS[$i]} at $(date) ==="
    python -m bnn_aenet.tasks.train \
        ...
        task_name=rad_forces_train \
        run_name=rad_forces_train_${i} \
        ...
        seed=${SEEDS[$i]}
    echo "=== Finished RAD Forces run $i at $(date) ==="
done
