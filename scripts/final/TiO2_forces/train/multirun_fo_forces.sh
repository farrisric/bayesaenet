...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/logs/multirun/fo_forces.out
#$ -e /home/g15farris/bin/bayesaenet/logs/multirun/fo_forces.err
...
# Best FO Forces HPS parameters (trial 22, total_rmse/val = 70.51)
LR=0.0003533164693908051
BS=256
MC=2
PRIOR_SCALE=0.1190650788603931
Q_SCALE=0.004973978807012779
OBS_SCALE=1.472990187333476

SEEDS=(121958 671155 131932 365838 259178 644167 110268 732180 54886 137337)

for i in $(seq 0 9); do
    echo "=== Starting FO Forces run $i with seed ${SEEDS[$i]} at $(date) ==="
    python -m bnn_aenet.tasks.train \
        ...
        task_name=fo_forces_train \
        run_name=fo_forces_train_${i} \
        ...
        seed=${SEEDS[$i]}
    echo "=== Finished FO Forces run $i at $(date) ==="
done
