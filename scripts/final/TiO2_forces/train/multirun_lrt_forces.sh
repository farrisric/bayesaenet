...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/logs/multirun/lrt_forces.out
#$ -e /home/g15farris/bin/bayesaenet/logs/multirun/lrt_forces.err
...
# Best LRT Forces HPS parameters (trial 3, total_rmse/val = 78.70)
# No mixed precision for LRT (causes NaN)
LR=0.0005473369642905611
BS=256
MC=2
PRIOR_SCALE=0.12603428384040463
Q_SCALE=0.0007957547437556391
OBS_SCALE=0.8254322184306713

SEEDS=(121958 671155 131932 365838 259178 644167 110268 732180 54886 137337)

for i in $(seq 0 9); do
    echo "=== Starting LRT Forces run $i with seed ${SEEDS[$i]} at $(date) ==="
    python -m bnn_aenet.tasks.train \
        ...
        task_name=lrt_forces_train \
        run_name=lrt_forces_train_${i} \
        ...
        seed=${SEEDS[$i]}
    echo "=== Finished LRT Forces run $i at $(date) ==="
done
