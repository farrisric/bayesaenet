...
python bnn_aenet/tasks/train.py \
    ...
    task_name=hom_lrt_train_100perc_grid_0.001_5 \
    datamodule=TiO \
    ...
    model.q_scale=0.001 \
    model.obs_scale=0.1\
    ckpt_path=/home/g15farris/bin/bayesaenet/bnn_aenet/logs/hom_lrt_train_100perc_grid_0.001_5/runs/2025-05-16_14-21-00/checkpoints/last.ckpt
