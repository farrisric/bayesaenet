...
python bnn_aenet/tasks/train.py \
    ...
    task_name=hom_lrt_train_100perc_grid_0.0001_10 \
    datamodule=TiO \
    datamodule.valid_split=100 \
    datamodule.batch_size=512 \
    model.lr=0.000013265605241311912 \
    model.mc_samples_train=2 \
    model.prior_scale=10 \
    model.q_scale=0.0001 \
    model.obs_scale=0.1\
    ckpt_path=/home/g15farris/bin/bayesaenet/bnn_aenet/logs/hom_lrt_train_100perc_grid_0.0001_10/runs/2025-05-16_14-19-21/checkpoints/last.ckpt
