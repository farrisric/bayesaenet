...
python bnn_aenet/tasks/train.py \
    ...
    task_name=hom_lrt_train_100perc_grid_0.0001_2 \
    datamodule=TiO \
    ...
    model.obs_scale=0.1\
    ckpt_path=/home/g15farris/bin/bayesaenet/bnn_aenet/logs/hom_lrt_train_100perc_grid_0.0001_2/runs/2025-05-16_14-19-21/checkpoints/last.ckpt
