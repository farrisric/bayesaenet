#!/bin/bash
#$ -N lrt_grid_q_0.0177_p0.0035
#$ -pe smp* 1
#$ -q iqtc12.q
#$ -S /bin/bash
#$ -cwd
#$ -o lrt_grid_q_0.0177_p0.0035.out
#$ -e lrt_grid_q_0.0177_p0.0035.err
#$ -m e
...
python bnn_aenet/tasks/train.py \
    ...
    task_name=hom_lrt_train_100perc_grid_0.0177_0.0035 \
    datamodule=TiO \
    ...
    model.q_scale=0.01766287299973241 \
