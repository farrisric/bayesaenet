#!/bin/bash
#$ -N lrt_grid_q_0.0002_p0.0350
#$ -pe smp* 1
#$ -q iqtc12.q
#$ -S /bin/bash
#$ -cwd
#$ -o lrt_grid_q_0.0002_p0.0350.out
#$ -e lrt_grid_q_0.0002_p0.0350.err
#$ -m e
