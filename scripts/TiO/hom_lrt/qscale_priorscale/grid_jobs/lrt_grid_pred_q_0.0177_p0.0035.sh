#!/bin/bash
#$ -N lrt_grid_pred_q_0.0177_p0.0035
#$ -pe smp* 1
#$ -q iqtc12.q
#$ -S /bin/bash
#$ -cwd
...
python bnn_aenet/tasks/predict.py \
        task_name=hom_lrt_train_100perc_grid_pred_0.0177_0.0035 \
        prediction=TiO \
        ckpt_path=all \
        datamodule.valid_split=100 \
        +method=HLRT \
        runs_dir=bnn_aenet/logs/hom_lrt_train_100perc_grid_0.0177_0.0035 \
