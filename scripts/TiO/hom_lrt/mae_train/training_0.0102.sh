...
python bnn_aenet/tasks/train.py \
    ...
    task_name=lrt_train_0.010 \
    datamodule=TiO \
    datamodule.valid_split=100 \
    datamodule.batch_size=32 \
    model.lr=0.00016968228154898345 \
    model.mc_samples_train=2 \
    model.prior_scale=1.3059317474789898 \
    model.q_scale=0.0014293757002125965 \
    model.obs_scale=0.634973757185219
