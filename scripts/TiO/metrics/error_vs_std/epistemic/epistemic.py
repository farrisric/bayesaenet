    ...
    for size in sizes:
        ...
        for run_name in model_runs:
            if model not in ['de', 'hnn']:
                ...
                y_std = (np.sqrt(rs['ep_vars'].to_numpy()) / e_scaling) / n_atoms
            if model == 'de':
...
fig.savefig("/home/g15farris/bin/bayesaenet/scripts/TiO/metrics/error_vs_std/epistemic/epistemic.png",
