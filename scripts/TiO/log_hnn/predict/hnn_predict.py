...
parquets = sorted(glob.glob('/home/g15farris/bin/bayesaenet/bnn_aenet/logs/hnn_pred_*/**/*parquet', recursive=True))
...
for i, parquet in enumerate(parquets):
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/scripts/TiO/hnn/predict/{name_file}_{train_percentage}.png', dpi=300)
    plt.close(fig)
    ...
    plt.savefig(f'/home/g15farris/bin/bayesaenet/scripts/TiO/hnn/predict/{name_file}_{train_percentage}_uct.png', dpi=300)
