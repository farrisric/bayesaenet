...
parquets = sorted(glob.glob('/home/g15farris/bin/bayesaenet/bnn_aenet/logs/*lrt_80perc/**/*parquet', recursive=True))
...
for parquet in parquets:
    ...
    fig.savefig(f'/home/g15farris/bin/bayesaenet/results/TiO/hnn/predict/{name}_uct.png', dpi=200)
