...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/predict/TiO2_small_pred_lrt_rmse_top3_t036.out
#$ -e /home/g15farris/bin/bayesaenet/log/predict/TiO2_small_pred_lrt_rmse_top3_t036.err
...
python -m bnn_aenet.tasks.predict_forces \
    ...
    --batch-size 128 \
    --mc-samples 20 \
    --run-name lrt_rmse_top3_t036 \
    --checkpoint-epoch 4987 \
    --checkpoint-step 4988
