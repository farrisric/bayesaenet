...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/predict/TiO2_small_pred_lrt_elbo_top3_t025.out
#$ -e /home/g15farris/bin/bayesaenet/log/predict/TiO2_small_pred_lrt_elbo_top3_t025.err
...
python -m bnn_aenet.tasks.predict_forces \
    ...
    --batch-size 128 \
    --mc-samples 20 \
    --run-name lrt_elbo_top3_t025 \
    --checkpoint-epoch 4157 \
    --checkpoint-step 20790
