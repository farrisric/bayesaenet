...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/train/TiO2_small_lrt_rmse_t036.out
#$ -e /home/g15farris/bin/bayesaenet/log/train/TiO2_small_lrt_rmse_t036.err
...
python -m bnn_aenet.tasks.train \
  ...
  trainer.max_epochs=50000 dataset=TiO2_small task_name=train run_name=lrt_rmse_top3_t036 \
  datamodule.batch_size=1024 model.lr=0.00038065386748451646 model.mc_samples_train=1 \
  model.prior_scale=0.31880952403956625 model.q_scale=0.00020030011645437814 model.obs_scale=0.5 \
