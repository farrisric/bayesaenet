...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/train/TiO2_small_rad_rmse_t066.out
#$ -e /home/g15farris/bin/bayesaenet/log/train/TiO2_small_rad_rmse_t066.err
...
python -m bnn_aenet.tasks.train \
  ...
  trainer.max_epochs=50000 dataset=TiO2_small task_name=train run_name=rad_rmse_top3_t066 \
  datamodule.batch_size=256 model.lr=0.0008445162546350286 model.mc_samples_train=2 \
  model.prior_scale=0.29863517917909244 model.q_scale=1.4443449370161928e-05 model.obs_scale=0.5 \
  ...
  callbacks.early_stopping.patience=1500 seed=110268 \
