...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/train/TiO2_small_lrt_rmse_t083.out
#$ -e /home/g15farris/bin/bayesaenet/log/train/TiO2_small_lrt_rmse_t083.err
...
python -m bnn_aenet.tasks.train \
  ...
  trainer.max_epochs=50000 dataset=TiO2_small task_name=train run_name=lrt_rmse_top3_t083 \
  datamodule.batch_size=1024 model.lr=0.0006245052479324426 model.mc_samples_train=2 \
  model.prior_scale=0.2750240298034271 model.q_scale=2.4714821530886258e-05 model.obs_scale=0.5 \
  ...
  callbacks.early_stopping.patience=1500 seed=121958 \
