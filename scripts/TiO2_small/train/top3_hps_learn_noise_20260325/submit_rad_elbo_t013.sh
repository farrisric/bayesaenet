...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/train/TiO2_small_rad_elbo_t013.out
#$ -e /home/g15farris/bin/bayesaenet/log/train/TiO2_small_rad_elbo_t013.err
...
python -m bnn_aenet.tasks.train \
  ...
  trainer.max_epochs=50000 dataset=TiO2_small task_name=train run_name=rad_elbo_top3_t013 \
  datamodule.batch_size=128 model.lr=0.0009998183169689775 model.mc_samples_train=2 \
  model.prior_scale=0.11802095722549726 model.q_scale=4.7917652495612536e-05 model.obs_scale=0.5 \
