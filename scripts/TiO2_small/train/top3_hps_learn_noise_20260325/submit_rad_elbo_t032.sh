...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/train/TiO2_small_rad_elbo_t032.out
#$ -e /home/g15farris/bin/bayesaenet/log/train/TiO2_small_rad_elbo_t032.err
...
python -m bnn_aenet.tasks.train \
  ...
  trainer.max_epochs=50000 dataset=TiO2_small task_name=train run_name=rad_elbo_top3_t032 \
  datamodule.batch_size=128 model.lr=0.0009801984630108704 model.mc_samples_train=1 \
  model.prior_scale=0.1306482704555069 model.q_scale=0.0013181504040602273 model.obs_scale=0.5 \
  ...
  callbacks.early_stopping.patience=1500 seed=137337 \
