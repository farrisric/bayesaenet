...
#$ -S /bin/bash
#$ -cwd
#$ -o /home/g15farris/bin/bayesaenet/log/multirun/TiO2_small_lrt_hetero.out
#$ -e /home/g15farris/bin/bayesaenet/log/multirun/TiO2_small_lrt_hetero.err
...
# Best LRT hetero HPS parameters for TiO2_small (study bnn_lrt_hetero, trial 7)
LR=0.00029994809793642315
BS=256
MC=1
PRIOR_SCALE=0.11881695873297937
Q_SCALE=4.1557941999062144e-05
NOISE_MIN=0.0630856220406674
...
for i in $(seq 0 9); do
    ...
    python -m bnn_aenet.tasks.train \
        ...
        seed=${SEEDS[$i]} \
        'tags=["TiO2_small", "lrt", "heteroscedastic", "train"]'
